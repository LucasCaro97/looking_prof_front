...
const Login = () => {
  ...
  const emailExists = async () => {
    try {
      const response = await axios.get(`http://200.58.107.39:9090/user/email?email=${email}`);
  ...
  const signIn = async (e) => {
    ...
    try {
      const responseData = await axios.post('http://200.58.107.39:9090/auth/login', { email, password });
