    ...
    useEffect(()=>{
        const fetchData = async (  ) =>{
            ...
            try {
                ...
                const response = await axios.get(`http://200.58.107.39:9090/user/${userId}`,{
                    headers: {
                ...
                const allProvinces = await axios.get(`http://200.58.107.39:9090/provinces/get`,{
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json'
                    }
                ...
                const allCity = await axios.get(`http://200.58.107.39:9090/city/get`,{
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json'
                    }
                ...
                const allProfessions = await axios.get(`http://200.58.107.39:9090/profession/get`,{
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json'
                    }
